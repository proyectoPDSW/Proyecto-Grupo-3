...
insert into Equipos_Complejos(serial,num_placa,disponibilidad,estado,modelo,asegurado,marca) values('asd123','1',FALSE,'en reparacion','Multimetro Digital',TRUE,'Fluke');
insert into Equipos_Complejos(serial,num_placa,disponibilidad,estado,modelo,asegurado,marca) values('d23j3s','2',TRUE,'prestamo diario','Multimetro Digital',TRUE,'Fluke');
insert into Equipos_Complejos(serial,num_placa,disponibilidad,estado,modelo,asegurado,marca) values('klñlkopk2421k','1',TRUE,'prestamo diario','Osciloscopio digital 50MHz',FALSE,'PCE');
...
insert into Equipo_prestamo_complejo (Prestamos_fecha_inicio,Prestamos_persona,Equipos_Complejos_serial,Equipos_Complejos_num_placa,Equipos_Complejos_modelo) values('2016-04-29 12:00:00','2105684','abd24b','1','generador de señales 5MHz');
insert into Equipo_prestamo_complejo (Prestamos_fecha_inicio,Prestamos_persona,Equipos_Complejos_serial,Equipos_Complejos_num_placa,Equipos_Complejos_modelo) values('2016-04-29 12:00:00','2105684','kb132k','2','generador de señales 5MHz');
insert into Equipo_prestamo_complejo (Prestamos_fecha_inicio,Prestamos_persona,Equipos_Complejos_serial,Equipos_Complejos_num_placa,Equipos_Complejos_modelo) values('2016-04-29 07:00:00','2105533','d23j3s','2','Multimetro Digital');
insert into Equipo_prestamo_complejo (Prestamos_fecha_inicio,Prestamos_persona,Equipos_Complejos_serial,Equipos_Complejos_num_placa,Equipos_Complejos_modelo) values('2016-04-29 07:00:00','2105533','klñlkopk2421k','1','Osciloscopio digital 50MHz');
insert into Equipo_prestamo_complejo (Prestamos_fecha_inicio,Prestamos_persona,Equipos_Complejos_serial,Equipos_Complejos_num_placa,Equipos_Complejos_modelo) values ('2016-04-27 12:00:00','2105684','klñlkopk2421k','1','Osciloscopio digital 50MHz');
