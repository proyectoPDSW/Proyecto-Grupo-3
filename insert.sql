...
insert into Modelos(vida_util,fotografia,valor_comercial,clase,descripcion,accesorios,nombre,marca) values('100000','https://www.pce-instruments.com/espanol/slot/4/artimg/large/pce-instruments-generador-de-funciones-pce-sdg1010-358155_635055.jpg','1139601','Generador de señales','generador de funciones','software de edición','generador de señales 5MHz','GW Instek');
insert into Modelos(vida_util,fotografia,valor_comercial,clase,descripcion,accesorios,nombre,marca) values('100000','http://www.ar.all.biz/img/ar/catalog/134366.png','1514998','Osciloscopio','Instrumento de visualización electrónico para la representación gráfica de señales eléctricas que pueden variar en el tiempo.','2 puntas de sonda, 1 software, 1 cable de red, instrucciones de uso','osciloscopio digital 50MHz','PCE');
insert into Modelos(vida_util,fotografia,valor_comercial,clase,descripcion,accesorios,nombre,marca) values('100000','http://2.bp.blogspot.com/_FOyXBkqQWYA/SxGfTGtKtDI/AAAAAAAAAF4/w4DfEEf2I0I/s1600/380-multimetro-digital-con-funda.jpg','100000','Multimetro','es un instrumento eléctrico portátil para medir directamente magnitudes eléctricas activas como corrientes y potenciales (tensiones) y/o pasivas como resistencias, capacidades y otras','2 puntas de sonda','multimetro digital','Fluke');
