...
public class RegistroPrestamoManageBean implements Serializable{
    ...
    public void registrarPrestamo(){
        try{
            if(getElQuePideElPrestamo().prioridad().get(-1).getRol().equals("Estudiante")){
                setPrestamo(new PrestamoTerminoFijo(elQuePideElPrestamo, equiposComplejosPrestados, equiposSencillosPrestados, fechaEstimadaDeEntrega));
