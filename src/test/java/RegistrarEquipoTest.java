...
public class RegistrarEquipoTest {
    ...
    public void CE2() throws IOException{
        ...
        Assert.fail("Registro dos veces el mismo equipo");
            ...
            Assert.assertEquals(e.getMessage(),"Ese equipo ya esta registrado");
    }
    }
    
    @Test
    public void CE3() throws Exception{
        properties.load(input);
        DAOFactory daof=DAOFactory.getInstance(properties);
        daof.beginSession();
    ...
    @Test
     public void CE4(){
        try{
            ...
            Assert.assertEquals("Ese equipo ya esta registrado",e.getMessage());
